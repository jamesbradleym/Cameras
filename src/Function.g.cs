...
namespace Cameras
{
    public class Function
    {
        ...
        private UrlModelStore<CamerasInputs> store;

        public async Task<CamerasOutputs> Handler(CamerasInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<CamerasInputs>();
            }
            

            var l = new InvocationWrapper<CamerasInputs,CamerasOutputs> (store, Cameras.Execute);
